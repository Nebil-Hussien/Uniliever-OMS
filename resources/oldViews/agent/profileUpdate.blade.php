   ...
   <script>
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <center><form action="/agent/update/edits" method= "POST" enctype="multipart/form-data"></center>
                    ...
                    @method('PUT')
                        ...
                        <input type="address" class="form-control" placeholder="your home address" id="address" name="address" value="{{$profile->address }}"></div>
        ...
        <option value="temporary">temporary id</option>
                        ...
                        <input type="date" class="form-control" value="{{$profile->ID_issue_date->format('y-m-d') }}" placeholder="when was you id issued" id="ID_issue_date" name="ID_issue_date"></div>
                        <div class="col-md-6"><label class="labels">ID expiry date </label>
                        <input type="date" class="form-control" value="{{$profile->ID_expiry_date->format('y-m-d') }}" placeholder="when will it expire" id="ID_expiry_date" name="ID_expiry_date"></div>
        ...
        <input type="text" class="form-control floating" name="businessAddress" id="pac-input" tabindex="10" value="{{$profile->businessAddress }}">
                        ...
                        <input type="text" class="form-control" value="{{$profile->businessEstablishmentYear }}" placeholder="eg: 2002" id="businessEstablishmentYear" name="businessEstablishmentYear"></div> <br>                                
                        <br><br>
