  ...
  <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create catagory</h1>
                        <div class="">
                        <div class="card mb-4">
                    ...
                    <div class="">
                    <center>
                        <form action="/admin/StoreCategory" method= "POST" enctype="multipart/form-data"></center>
                    @csrf
                    <div class="mb-3">
                     <label> Catagory Name</label>
                       <input type="text" id="product_catagory_name" name="product_catagory_name" class="form-control">
                    </div>
