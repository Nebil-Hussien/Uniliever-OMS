...
<script
   ...
   <script>
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="/romDashboard"> {{ Auth::user()->firstName }} {{ Auth::user()->middleName }}</a>
            <!-- Sidebar Toggle-->
            ...
            @guest
                  ...
                  "
                              ...
                              <ul class="dropdown-menu dropdown-menu-end user-dd animated"
                                  ...
                                  @if (auth()->user()->rom == Null)
                                  <a class="dropdown-item" href="rom/create/post"><i
                                    class="mdi mdi-settings me-1 ms-1"></i> Set-Up Account</a>
                                  @else
                                  
                                    <a class="dropdown-item" href="/romProfile/show"><i
        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/newDeliveries">New Deliveries</a>
                                    <a class="nav-link" href="/handover2History">Handovers</a>
                                    <a class="nav-link" href="">Delivery History</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               ...
                               change the attribute you want and click submit!
                            </div>
                            <div class="card-body">
                    ...
                    <center><form action="/rom/update/edits" method= "POST" enctype="multipart/form-data"></center>
                    ...
                    @method('PUT')
                        ...
                        <input type="text" class="form-control" placeholder="your home address" id="email" name="email"  value="{{$profile->email }}"></div>
                        
                        <div class="col-md-6"> <label class="labels">Address </label>
        <input type="text" class="form-control floating" name="address" id="pac-input" tabindex="10"value="{{$profile->address }}">
                                         <div id="map">
                                         </div>
                                         <div id="infowindow-content">
                                             <span id="place-name" class="title"></span>
                                             <span id="place-address"></span>
                                         </div></div> <div class="col-md-6"><label class="labels">Mobile</label>
        ...
        <option value="temporary">temporary id</option>
                        ...
                        <div class="col-md-6"><label class="labels">Attach your company ID </label>
                        ...
                        <input type="text" class="form-control" value="{{$profile->company_id_number }}" placeholder="licence number" id="licenceNumber" name="licenceNumber"></div>
                        <div class="col-md-6"><label class="labels">company ID issue date </label>
                        <input type="date" class="form-control" value="{{$profile->company_id_issue_date }}" placeholder="" id="issueDate" name="issueDate"></div>
                        <div class="col-md-6"><label class="labels">company ID expiry Date </label>
                        <input type="date" class="form-control" value="{{$profile->company_id_expiry_date }}" placeholder="" id="expiryDate" name="expiryDate"></div><br>
                        <br><br>
