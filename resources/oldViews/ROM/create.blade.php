    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="/DeliveryHistory">Delivery History</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="row mt-2">
                    <center><form action="/rom/create/posts" method= "POST" enctype="multipart/form-data"></center>
                    @csrf    
      ...
      <div class="col-md-6"><label class="labels">Mobile</label>
        ...
        <option value="temporary">temporary id</option>
                        ...
                        <div class="col-md-6"><label class="labels"> company IDissue date </label>
