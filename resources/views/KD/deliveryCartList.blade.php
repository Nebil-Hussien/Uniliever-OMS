            ...
            <div class="container px-6 py-3 mx-auto">
                ...
                <nav  class="p-6 mt-4 text-white bg-black sm:flex sm:justify-center sm:items-center">
                    <div class="flex flex-col sm:flex-row">
                        <a class="mt-3 hover:underline sm:mx-3 sm:mt-0" href="/key_distroDashboard">Home</a>
              ...
              @foreach ($cartItems as $item)
                            ...
                            @endforeach
              <button type="submit" class="mt-3 hover:underline sm:mx-3 sm:mt-0">handover List</button>
                </form>


                        <a href="{{ route('deliveryCart.list') }}" class="flex items-center">
