...
<script
  ...
  <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="">
                    <center>
                        <form action="/editCatagory/product" method= "POST" enctype="multipart/form-data"></center>
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                     <label> Catagory Name</label>
                       <input type="text" name="catagoryName" value="{{ $productCatagory->catagoryName }}" class="form-control">
                    </div>

                    <div class="mb-3">
                     <label> Image</label>
                       <input type="file" name="catagory_image" value="{{ $productCatagory->catagory_image }}" class="form-control">
                    </div>


                    <div class="mb-3">
                     <label> Description</label>
                       <textarea name="description" rows="5"> {{ $productCatagory->description }} class="form-control"></textarea>
                    </div>
